import { Collection, EtherscanLinkType, TempleLinkType } from '@johnkcr/temple-lib/dist/types/core';
import { FeedEventType, NftSaleEvent } from '@johnkcr/temple-lib/dist/types/core/feed';
import { Token } from '@johnkcr/temple-lib/dist/types/core/Token';
import {
  firestoreConstants,
  getCollectionDocId,
  getEtherscanLink,
  ...
  getUserDisplayName,
  trimLowerCase
} from '@johnkcr/temple-lib/dist/utils';
      ...
      const events = sales
        .map((item, index) => {
          ...
          const nftSaleEvent: NftSaleEvent = {
            ...
            hasBlueCheck: false,
            collectionProfileImage: image,
            internalUrl: getTempleLink({
